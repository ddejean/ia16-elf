"""A module for defining WORKSPACE dependencies required for ia16-elf"""

load("@bazel_tools//tools/build_defs/repo:http.bzl", "http_archive")
load("@bazel_tools//tools/build_defs/repo:utils.bzl", "maybe")

# buildifier: disable=unnamed-macro
def rules_ia16_elf_dependencies():
    maybe(
        http_archive,
    ...
    maybe(
        http_archive,
        name = "gmp-6.1.2",
        build_file = "@ia16-elf//gmp-6.1.2:BUILD",
    ...
    maybe(
        http_archive,
        name = "mpfr-3.1.5",
        build_file = "@ia16-elf//mpfr-3.1.5:BUILD",
    ...
    maybe(
        http_archive,
        name = "mpc-1.0.3",
        build_file = "@ia16-elf//mpc-1.0.3:BUILD",
    ...
    maybe(
        http_archive,
        name = "isl-0.16.1",
        build_file = "@ia16-elf//isl-0.16.1:BUILD",
    ...
    maybe(
        http_archive,
        name = "binutils-2.39",
        build_file = "@ia16-elf//binutils-2.39:BUILD",
    ...
    maybe(
        http_archive,
        name = "gcc-6.3.0",
        build_file = "@ia16-elf//gcc-6.3.0:BUILD",
